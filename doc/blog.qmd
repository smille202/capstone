...
# Introduction
According to *[The National Oceanic and Atmospheric Administration](https://www.rainn.org/statistics/scope-problem)* (NOAA), natural disasters in the United States have increased in both frequency and severity over the past few decades. At the same time, homeowners' insurance premiums have steadily risen, leading to concerns by many about the factors that seems to be driving these premium increases. 
